...
try:
    ...
    from models.v3_pipeline import V3FusionModule
    ...
    print(f"  loaded in {time.time() - t0:.1f}s  keys={list(ck.keys())}",
          flush=True)
    ...
    univfd_ck = torch.load(UNIVFD_CKPT, map_location="cpu",
                            weights_only=False)
