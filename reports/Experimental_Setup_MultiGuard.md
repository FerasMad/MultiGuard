...
| Item | Value | Source |
| --- | --- | --- |
| GPU | 2 × NVIDIA RTX 4090 (24 GB each → 48 GB total VRAM) | docs/V4_PLAN.md, docs/MULTIGUARD_SETUP.md |
...
| Storage | ~30 GB (code + models + small data); ~155 GB for the full datasets (VisualNews 99 GB, DGM4 21 GB, NewsCLIPpings 21 GB, MMFakeBench 14 GB) | docs/MULTIGUARD_SETUP.md |
